...
def patch_settings(test_settings: Settings):
    """
    Inject test_settings into get_settings() for every test.
    Also calls configure_logging() so structlog is properly configured
    and modules using get_logger() don't get a bare PrintLogger.
    """
